...
class FastNetwork:
    ...
    def compute_signal(self, pop_params, indiv_params, indiv_number, time):
        ...
        signal = np.divide(space_shift, thickness*np.exp(delta)) + delta - np.divide(nu, thickness * time)
