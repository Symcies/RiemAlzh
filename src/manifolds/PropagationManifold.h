...
private:
    PropagationManifold(const AbstractManifold &); //Voluntarily not implemented, prevents automatic copy by compiler
    PropagationManifold& operator=(const AbstractManifold &); //Voluntarily not implemented, prevents automatic copy by compiler
